            ...
            <Row>
                        ...
                        <tbody>
                            ...
                            {gameList.total.map((item) => (
                                <tr className="game-details" key={item.appid}>
                                    ...
                                    <td className="secondary-data text-center text-med">{bigCurrencyFormat(item.total_reviews * item.initial_price * med_player_multiplier)}</td>
                                    <td className="secondary-data text-center text-med">{numberFormat(item.total_reviews * med_player_multiplier)}</td>
                                </tr>
                            ))}
                        </tbody>
                    </Table>
                ...
                <Col>
                    <Table size="sm" className="popular-game-table">
                        <tbody>
                            <tr>
                                <td colSpan={2} className="text-med font-weight-bold">Recent Best Selling Games <span className="data">(1 month)</span></td>
                                <td className="text-center">Estimated Revenue</td>
                                <td className="text-center">Estimated Owners</td>
                            </tr>
